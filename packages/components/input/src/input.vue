<template>
    <div :class="[bem.b(), bem.m(size), bem.is('disabled', disabled)]">
        <div :class="bem.e('wrapper')">
            ...
            <input ref="input" :class="bem.e('inner')" :type="password && !showPassword ? 'password' : 'text'"
                :disabled="disabled" @compositionstart="handleCompositionStart" @compositionupdate="handleCompositionUpdate"
                @compositionend="handleCompositionEnd" @input="handleInput($event)" @change="handleChange($event)"
                v-bind="$attrs" />
            ...
            <span :class="bem.e('suffix')" v-if="showSuffix">
                <span :class="bem.e('suffix-inner')">
                    ...
                    <!-- 清空按钮 -->
                    <span :class="bem.e('clear')" v-if="!disabled && allowClear && modelValue" @click="onClear">
                        <svg t="1694424291879" class="icon" viewBox="0 0 1024 1024" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" p-id="1392">
                            <path
                    ...
                    <span :class="bem.e('password')" v-if="password" @click="onPassword">
                        <svg focusable="false" v-show="showPassword" class="u-eye" data-icon="eye" width="1em" height="1em"
                        ...
                        <svg focusable="false" v-show="!showPassword" class="u-eye" data-icon="eye-invisible" width="1em"
...
import { UPDATE_MODEL_EVENT } from "@tooy-ui/constants";
